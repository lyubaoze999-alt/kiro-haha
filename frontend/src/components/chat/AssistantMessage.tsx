...
export const AssistantMessage = memo(function AssistantMessage({ content, isStreaming, branchAction, sessionId, timestamp, credits }: Props) {
  ...
  return (
    <div className="mb-5 flex justify-start">
      ...
      >
        ...
        {!isStreaming && typeof credits === 'number' && credits > 0 && (
          <div className="mt-1.5 flex items-center gap-1 px-1 text-[11px] font-medium tabular-nums text-[var(--color-text-tertiary)]">
            <Zap size={11} strokeWidth={2.2} aria-hidden="true" />
            <span>{credits.toFixed(3)} credits</span>
          </div>
        )}
