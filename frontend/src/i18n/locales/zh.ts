...
export const zh: Record<TranslationKey, string> = {
  ...
  'sidebar.newSessionDefaultFolder': '已为你在「{folder}」中新建会话',
  ...
  'settings.activity.defaultHandle': 'github.com/lyubaoze999-alt/kiro-haha',
  ...
  // ─── Empty Session ──────────────────────────────────────
  'empty.title': '新建会话',
  'empty.subtitle': '开始一个新的编码会话。Kiro 已准备好帮你构建、调试和架构你的项目。',
  ...
  // ─── Quota / Credits ────────────────────────────
  'quota.detailTitle': 'Credits 余量',
  'quota.used': '已用',
  'quota.remaining': '剩余',
  'quota.resetTime': '重置时间',
